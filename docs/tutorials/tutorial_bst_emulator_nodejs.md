...
*Please note - our [Virtual Alexa project](https://github.com/bespoken/virtual-alexa) has replaced the BSTAlexa classes.*
[You can read our tutorial on Virtual Alexa here](tutorial_alexa_unit_testing). This API will be deprecated in a future version.
