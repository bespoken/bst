...
program
    ...
    .action( function (port: number, options: any) {
        if (options.secure) {
            ...
            console.log(chalk.hex("#ff6633")(URLMangler.manglePipeToPath(Global.config().sourceID(), Global.config().secretKey())));
            console.log("");
        } else {
            console.log("Your public URL for accessing your local service:");
            console.log(chalk.hex("#ff6633")(URLMangler.manglePipeToPath(Global.config().sourceID())));
            console.log("");
        }

        console.log("Your URL for viewing requests/responses sent to your service:");
        console.log(chalk.hex("#ff6633")(URLMangler.mangleNoPath(Global.config().sourceID(), Global.config().secretKey())));
