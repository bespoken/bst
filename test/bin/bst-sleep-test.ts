...
describe("bst-sleep", function() {
    ...
    describe("sleep command", function() {
        it("sleep with no-args", function (done) {
            ...
            sandbox.stub(process.stdout, "write").callsFake(function (data?: string) {
        ...
        xit("sleep with non-brooklyn", function (done) {
            ...
            sandbox.stub(console, "log").callsFake(function (data?: string) {
        ...
        xit("sleep with brooklyn", function (done) {
